...
import { addToWhislist, removeFromWhislist } from "../features/whislistSlice";
...
const AllProducts = () => {
  ...
  // Set up initial wishlist states based on the Redux store
  ...
  //     acc[product._id] = true; // Set true for products already in the wishlist
  //     return acc;
  //   }, {})
  // );

  // // Toggle wishlist state when clicking the heart icon
  // const whislistBtnToggler = (product) => {
  //   const isInWishlist = wishlistStates[product._id];

  //   if (isInWishlist) {
  //     // Remove product from wishlist
  //     removeFromWhislistHandler(product);
  //     setWishlistStates((prevStates) => ({
  //       ...prevStates,
  //       [product._id]: false, // Update state to reflect removal
  //     }));
  //   } else {
  //     // Add product to wishlist
  //     addToWhistlistHandler(product);
  //     setWishlistStates((prevStates) => ({
  //       ...prevStates,
  //       [product._id]: true, // Update state to reflect addition
  //     }));
  //   }
  // };
